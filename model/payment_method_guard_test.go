...
func insertSubscriptionOrderForPaymentGuardTest(t *testing.T, tradeNo string, userID int, planID int, paymentMethod string, paymentProvider string) {
	t.Helper()
...
func TestRechargeWaffoPancake_RejectsMismatchedPaymentMethod(t *testing.T) {
	...
	insertTopUpForPaymentGuardTest(t, "waffo-pancake-guard", 101, PaymentMethodStripe, PaymentProviderStripe)
...
func TestUpdatePendingTopUpStatus_RejectsMismatchedPaymentMethod(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(tc.name, func(t *testing.T) {
			...
			insertTopUpForPaymentGuardTest(t, tc.tradeNo, 150, tc.storedPaymentMethod, tc.storedPaymentProvider)
...
func TestCompleteSubscriptionOrder_RejectsMismatchedPaymentMethod(t *testing.T) {
	...
	insertSubscriptionOrderForPaymentGuardTest(t, "sub-guard-order", 202, plan.Id, PaymentMethodStripe, PaymentProviderStripe)
...
func TestExpireSubscriptionOrder_RejectsMismatchedPaymentMethod(t *testing.T) {
	...
	insertSubscriptionOrderForPaymentGuardTest(t, "sub-expire-guard", 303, plan.Id, PaymentMethodStripe, PaymentProviderStripe)
