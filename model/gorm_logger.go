...
func newGormLogger(w io.Writer) logger.Interface {
	...
	// Sanitizing at the writer layer preserves GORM's original call-site reporting.
...
// Driver-generated errors may inline query data, so non-debug logs retain only error codes.
