...
func TestGetUnrefundedFailedTasks_FiltersAndLimits(t *testing.T) {
	...
	tasks := []*Task{
		{TaskID: "failed_refundable_1", Status: TaskStatusFailure, Quota: 100, RefundPending: true, SubmitTime: TaskRefundLegacyCutoff, Data: json.RawMessage(`{}`)},
		{TaskID: "failed_refundable_2", Status: TaskStatusFailure, Quota: 200, RefundPending: true, SubmitTime: TaskRefundLegacyCutoff + 1, Data: json.RawMessage(`{}`)},
		{TaskID: "legacy_failed", Status: TaskStatusFailure, Quota: 400, RefundPending: true, SubmitTime: TaskRefundLegacyCutoff - 1, Data: json.RawMessage(`{}`)},
		{TaskID: "historical_failed_without_marker", Status: TaskStatusFailure, Quota: 500, SubmitTime: TaskRefundLegacyCutoff + 2, Data: json.RawMessage(`{}`)},
