...
func InitOptionMap() {
	...
	common.OptionMap["AuditLogRetentionDays"] = "90"
	...
	common.OptionMap["MemberTierRules"] = setting.MemberTierRules2JSONString()
...
func updateOptionMap(key string, value string) (err error) {
	...
	case "MarketingEmailSubjectTemplate":
	...
	case "MemberTierRules":
		err = setting.UpdateMemberTierRulesByJSONString(value)
