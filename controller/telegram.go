...
func TelegramBind(c *gin.Context) {
	...
	_ = recordSecurityEvent(c, &model.AuditLog{UserId: user.Id, Category: model.AuditCategorySecurity, Action: "telegram.bind", Ip: c.ClientIP(), Success: true, RequestId: c.GetString(common.RequestIdKey)})
