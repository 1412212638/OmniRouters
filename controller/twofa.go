...
func Enable2FA(c *gin.Context) {
	...
	_ = recordSecurityEvent(c, &model.AuditLog{UserId: userId, Category: model.AuditCategorySecurity, Action: "2fa.enable", Ip: c.ClientIP(), Success: true, RequestId: c.GetString(common.RequestIdKey)})
...
func Disable2FA(c *gin.Context) {
	...
	_ = recordSecurityEvent(c, &model.AuditLog{UserId: userId, Category: model.AuditCategorySecurity, Action: "2fa.disable", Ip: c.ClientIP(), Success: true, RequestId: c.GetString(common.RequestIdKey)})
...
func RegenerateBackupCodes(c *gin.Context) {
	...
	_ = recordSecurityEvent(c, &model.AuditLog{UserId: userId, Category: model.AuditCategorySecurity, Action: "2fa.backup_codes.regenerate", Ip: c.ClientIP(), Success: true, RequestId: c.GetString(common.RequestIdKey)})
