...
func GetStatus(c *gin.Context) {
	...
	data := gin.H{
		...
		"model_square_show_usage_metrics": cs.ModelSquareShowUsageMetrics,
...
func SendEmailVerification(c *gin.Context) {
	...
	subject, content := common.BuildEmailVerificationMail(common.SystemName, code, common.VerificationValidMinutes)
...
func SendPasswordResetEmail(c *gin.Context) {
	...
	if _, err := model.GetUniqueUserByEmail(email); err == nil {
		...
		subject, content := common.BuildPasswordResetMail(common.SystemName, link, common.VerificationValidMinutes)
		err := common.SendEmail(subject, email, content)
		if err != nil {
