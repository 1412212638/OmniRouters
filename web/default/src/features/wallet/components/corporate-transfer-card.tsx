...
function CopyableRow({ label, value, icon }: CopyableRowProps) {
  ...
  return (
    <div className='bg-background grid gap-1.5 rounded-md border px-3 py-2.5 sm:grid-cols-[8rem_minmax(0,1fr)_auto] sm:items-center'>
    ...
    >
      ...
      <div className='space-y-2'>
        ...
        <div className='relative overflow-hidden rounded-lg border border-dashed p-3'>
          ...
          {!acknowledged && (
            <div className='bg-background/45 absolute inset-0 flex items-center justify-center px-4 text-center text-sm font-medium backdrop-blur-[1px]'>
              {t(
