        ...
        <div className="min-w-0 flex-1">
          <div className="flex items-center gap-2">
            ...
            {marketplaceDisplay.showNew && (
              <span className="rounded-full border border-red-500/20 bg-red-500/10 px-1.5 py-0.5 text-[10px] font-semibold text-red-700 dark:text-red-300">
                NEW
              </span>
            )}
            {marketplaceDisplay.discountLabel && (
              <span className="rounded-full border border-orange-500/25 bg-orange-500/10 px-1.5 py-0.5 text-[10px] font-semibold text-orange-700 dark:text-orange-300">
                {marketplaceDisplay.discountLabel}
              </span>
            )}
            {marketplaceDisplay.discountLabel &&
        ...
        <div className="shrink-0 text-right">
          {isTokenBased ? (
            ...
            <div>
              ...
              {originalPriceGroup && (
                <div className="text-muted-foreground/40 font-mono text-xs line-through tabular-nums">
                  {formatFixedPrice(
                    model,
                    originalPriceGroup,
                    showRechargePrice,
