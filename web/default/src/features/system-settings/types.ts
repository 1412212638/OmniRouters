...
export type MarketingEmailUser = {
  id: number
  username?: string
  display_name?: string
  email?: string
...
export type SearchMarketingEmailUsersParams = {
  keyword?: string
  group?: string
  p?: number
  page_size?: number
...
export type SearchMarketingEmailUsersResponse = {
  success: boolean
  message?: string
  data?: {
    items: MarketingEmailUser[]
    total: number
    page: number
    page_size: number
  }
...
export type SendMarketingEmailRequest = {
  user_ids: number[]
  subject_template: string
  content_template: string
}

export type SendMarketingEmailResponse = {
  success: boolean
  message?: string
  data?: {
    total?: number
...
export type ContentSettings = {
  ...
  'console_setting.model_square_carousel': string
...
export type ModelSettings = {
  ...
  'billing_setting.sora_per_request_pricing': string
  ...
  'group_ratio_setting.group_model_ratio': string
  'group_ratio_setting.group_model_user_ratio': string
  'group_ratio_setting.group_model_ratio_expiry': string
  RetryTimes: number
