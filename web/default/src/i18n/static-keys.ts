...
export const STATIC_I18N_KEYS = [
  ...
  'No member tiers configured',
  'Member tier benefits will appear here once enabled.',
  'View tier progress and group-based benefits.',
  'Tier progress and group-based benefits',
  'View your current tier and group-based benefits.',
  ...
  'No member tiers configured. Add a tier to get started.',
  'Tier thresholds must be non-negative.',
  'Tier {{index}} must select a group.',
  'Tier group cannot be duplicated: {{group}}',
  ...
  'Actual Amount',
  'Total Quota',
  'Allowed Subscription Groups',
  'Allowed Groups',
  'All groups',
  'All groups (unrestricted)',
  'No groups available',
