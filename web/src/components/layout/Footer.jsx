...
const FooterBar = () => {
  ...
  const projectDocsUrl =
    statusState?.status?.docs_link || `${projectRepoUrl}#readme`;
  const projectIssuesUrl = `${projectRepoUrl}/issues`;
  const projectReleasesUrl = `${projectRepoUrl}/releases`;
