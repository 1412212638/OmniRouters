...
var channelAffinityUsageCacheStatsTestSeq atomic.Int64

func channelAffinityUsageCacheStatsTestKey(t *testing.T, prefix string) string {
	t.Helper()
	return fmt.Sprintf("%s_%s_%d", prefix, t.Name(), channelAffinityUsageCacheStatsTestSeq.Add(1))
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName := channelAffinityUsageCacheStatsTestKey(t, "rule")
	usingGroup := "default"
	keyFP := channelAffinityUsageCacheStatsTestKey(t, "fp")
