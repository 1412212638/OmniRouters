...
func printHelp() {
	fmt.Println("OmniRouters " + Version + " - The next-generation LLM gateway and AI asset management system supports multiple languages.")
	fmt.Println("Original Project: OneAPI by JustSong - https://github.com/songquanpeng/one-api")
	fmt.Println("Project Repository: https://github.com/1412212638/OmniRouters")
	fmt.Println("Usage: omnirouters [--port <port>] [--log-dir <log directory>] [--version] [--help]")
}
